...
class SerialisationItem {
    ...
    SerialisationItems([System.String] $name, [System.String] $path, [System.String] $database)
    {
        $this.Name = $name
        $this.Path = $path
    ...
    SerialisationItems([System.String] $name, [System.String] $path, [System.String] $database, [System.String] $scope)
    {
        $this.Name = $name
        $this.Path = $path
        $this.Database = $database
...
class SerialisationModule {
    ...
    SerialisationModule([System.String] $namespace, [System.Collections.ArrayList] $references, [System.Collections.ArrayList] $items)
    {
...
function Convert-Serialisation {
    param (
